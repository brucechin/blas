...
TEST(MatrixCalculator, Add) {
	...
	Matrix* res = calculator->add(a, b, num);
	a->clear();
	b->clear();
	res->clear();
}
...
TEST(MatrixCalculator, Mul){
	...
	Matrix* res = MatrixCalculator::mul(a, b, num);
	res->clear();
	a->clear();
	b->clear();
}
...
TEST(MatrixCalculator, Div){
	...
	Matrix* b = new Matrix();
	b->readMatrix(matrix_b);
	Matrix* res = calculator->div(a, b, num);
	a->clear();
	b->clear();
	res->clear();
}
...
TEST(MatrixCalculator, Max){
	...
	Matrix* b = new Matrix();
	b->readMatrix(matrix_b);
	Matrix* res = calculator->max(a, b, num);
	a->clear();
	b->clear();
	res->clear();
}
...
TEST(MatrixCalculator, Min){
	...
	Matrix* b = new Matrix();
	b->readMatrix(matrix_b);
	Matrix* res = calculator->min(a, b, num);
	a->clear();
	b->clear();
	res->clear();
}
...
TEST(MatrixCalculator, BiggerAndSmaller){
	...
	Matrix* b = new Matrix();
	b->readMatrix(matrix_b);
	LogicMatrix* res1 = calculator->bigger(a, b, num);
	a->clear();
	b->clear();
	res1->clear();
}
...
TEST(MatrixCalculator, Equal){
	...
	Matrix* b = new Matrix();
	b->readMatrix(matrix_b);
	LogicMatrix* res1 = calculator->equal(a, b, num);
	a->clear();
	b->clear();
	res1->clear();
}
...
TEST(MatrixCalculator, Condition){
	...
	Matrix* res1 = calculator->condition(la, a, b, num);
	Matrix* res2 = calculator->condition(lb, a, b, num);
	a->clear();
	b->clear();
	res1->clear();
	res2->clear();
...
TEST(MatrixCalculator, Round){
	...
	Matrix* b = new Matrix();
	b->readMatrix(matrix_b);
	Matrix* res1 = calculator->round(a, num);
	Matrix* res2 = calculator->round(b, num);
	a->clear();
	b->clear();
	res1->clear();
	res2->clear();
...
TEST(MatrixCalculator, Floor){
	...
	Matrix* b = new Matrix();
	b->readMatrix(matrix_b);
	Matrix* res1 = calculator->floor(a, num);
	Matrix* res2 = calculator->floor(b, num);
	a->clear();
	b->clear();
	res1->clear();
	res2->clear();
...
TEST(MatrixCalculator, Abs){
	...
	Matrix* b = new Matrix();
	b->readMatrix(matrix_b);
	Matrix* res1 = calculator->abs(a, num);
	Matrix* res2 = calculator->abs(b, num);
	a->clear();
	b->clear();
	res1->clear();
	res2->clear();
...
TEST(MatrixCalculator, Minus){
	...
	Matrix* b = new Matrix();
	b->readMatrix(matrix_b);
	Matrix* res1 = calculator->minus(a, num);
	Matrix* res2 = calculator->minus(b, num);
	a->clear();
	b->clear();
	res1->clear();
	res2->clear();
...
TEST(MatrixCalculator, Sqrt){
	...
	Matrix* b = new Matrix();
	b->readMatrix(matrix_b);
	Matrix* res1 = calculator->sqrt(a, num);
	Matrix* res2 = calculator->sqrt(b, num);
	a->clear();
	b->clear();
	res1->clear();
	res2->clear();
...
TEST(MatrixCalculator, Log){
	...
	Matrix* b = new Matrix();
	b->readMatrix(matrix_b);
	Matrix* res1 = calculator->log(a, num);
	Matrix* res2 = calculator->log(b, num);
	a->clear();
	b->clear();
	res1->clear();
	res2->clear();
...
TEST(MatrixCalculator, Exp){
	...
	Matrix* b = new Matrix();
	b->readMatrix(matrix_b);
	Matrix* res1 = calculator->exp(a, num);
	Matrix* res2 = calculator->exp(b, num);
	a->clear();
	b->clear();
	res1->clear();
	res2->clear();
...
TEST(MatrixCalculator, Sign){
	...
	Matrix* b = new Matrix();
	b->readMatrix(matrix_b);
	Matrix* res1 = calculator->sign(a, num);
	Matrix* res2 = calculator->sign(b, num);
	a->clear();
	b->clear();
	res1->clear();
	res2->clear();
...
TEST(MatrixCalculator, Inverse){
	...
	Matrix* b = new Matrix();
	b->readMatrix(matrix_b);
	Matrix* res1 = calculator->inverse(a, num);
	Matrix* res2 = calculator->inverse(b, num);
...
TEST(MatrixCalculator, SignedPow){
	...
	Matrix* b = new Matrix();
	b->readMatrix(matrix_b);
	Matrix* res1 = calculator->signedpow(a, 3, num);
	Matrix* res2 = calculator->signedpow(b, 3, num);
	a->clear();
	b->clear();
	res1->clear();
	res2->clear();
...
TEST(MatrixCalculator, Delay){
	...
	Matrix* b = new Matrix();
	b->readMatrix(matrix_b);
	Matrix* res1 = calculator->delay(a, step, num);
...
TEST(MatrixCalculator, Delta){
	...
	Matrix* b = new Matrix();
	b->readMatrix(matrix_b);
	Matrix* res1 = calculator->delta(a, step, num);
...
TEST(MatrixCalculator, Ratio){
	...
	Matrix* b = new Matrix();
	b->readMatrix(matrix_b);
	Matrix* res1 = calculator->ratio(a, step, num);
