...
const double MatrixCalculator::VALIDITY_PERCENTAGE_REQUIREMENT = 0.0;
 ...
 Matrix* MatrixCalculator::shift(Matrix* mat, int n)
{
 ...
 Matrix* MatrixCalculator::shift(Matrix* mat, int n, int num)
{
    int nrow = mat->getNRow();
    int ncol = mat->getNCol();
    int colnum = std::min(num, ncol);
...
Matrix* MatrixCalculator::sum_op(Matrix* mat, int n, int num)
{
    int nrow = mat->getNRow();
    int ncol = mat->getNCol();
    Matrix *res = new Matrix(nrow, ncol);
...
Matrix* MatrixCalculator::product_op(Matrix* mat, int n, int num)
{
    int nrow = mat->getNRow();
    int ncol = mat->getNCol();
    Matrix *res = new Matrix(nrow, ncol);
 ...
 Matrix *MatrixCalculator::tsMax_op(Matrix* mat, int n, int num)
{
    int nrow = mat->getNRow();
    int ncol = mat->getNCol();
    Matrix *res = new Matrix(nrow, ncol);
...
Matrix *MatrixCalculator::tsMin_op(Matrix* mat, int n, int num)
{
    int nrow = mat->getNRow();
    int ncol = mat->getNCol();
    Matrix *res = new Matrix(nrow, ncol);
...
Matrix *MatrixCalculator::tsArgmin_op(Matrix* mat, int n, int num)
{
    int nrow = mat->getNRow();
    int ncol = mat->getNCol();
    Matrix *res = new Matrix(nrow, ncol);
...
Matrix *MatrixCalculator::tsArgmax_op(Matrix* mat, int n, int num)
{
    int nrow = mat->getNRow();
    int ncol = mat->getNCol();
    Matrix *res = new Matrix(nrow, ncol);
...
Matrix *MatrixCalculator::tsCountNaN_op(Matrix* mat, int n, int num)
{
    int nrow = mat->getNRow();
    int ncol = mat->getNCol();
    Matrix *res = new Matrix(nrow, ncol);
...
Matrix *MatrixCalculator::tsCountTrue_op(LogicMatrix* mat, int n, int num)
{
    int nrow = mat->getNRow();
    int ncol = mat->getNCol();
    Matrix *res = new Matrix(nrow, ncol);
...
Matrix *MatrixCalculator::tsCountConsecutiveTrue_op(LogicMatrix* mat, int n, int num)
{
    int nrow = mat->getNRow();
    int ncol = mat->getNCol();
    Matrix *res = new Matrix(nrow, ncol);
...
Matrix* MatrixCalculator::tsMean_op(Matrix* mat, int n, int num){
    int nrow = mat->getNRow();
    int ncol = mat->getNCol();
    Matrix *res = new Matrix(nrow, ncol);
    int* tsNotNanCount = new int[ncol];//count the number of not NAN in a sliding window
...
//Implement rolling variance algorithm to reduce computation complexity
Matrix *MatrixCalculator::tsStd_op(Matrix* mat, int n, int num)
{
    int nrow = mat->getNRow();
    int ncol = mat->getNCol();
    Matrix *res = new Matrix(nrow, ncol);
...
Matrix *MatrixCalculator::tsSkewness_op(Matrix* mat, int n, int num)
{
    int nrow = mat->getNRow();
    int ncol = mat->getNCol();
    Matrix *res = new Matrix(nrow, ncol);
 ...
 Matrix *MatrixCalculator::tsRank_op(Matrix* mat, int n, int num)
{
    int nrow = mat->getNRow();
    int ncol = mat->getNCol();
    Matrix *res = new Matrix(nrow, ncol);
 ...
 Matrix *MatrixCalculator::tsCov_op(Matrix* mat1, Matrix* mat2, int n, int num)
{
    int nrow = mat1->getNRow();
    int ncol = mat1->getNCol();
    Matrix *res = new Matrix(nrow, ncol);
 ...
 Matrix *MatrixCalculator::tsCorr_op(Matrix* mat1, Matrix* mat2, int n, int num)
{
    int nrow = mat1->getNRow();
    int ncol = mat1->getNCol();
    Matrix *res = new Matrix(nrow, ncol);
...
Matrix* MatrixCalculator::tsKurtosis_op(Matrix* mat, int n, int num)
{
    int nrow = mat->getNRow();
    int ncol = mat->getNCol();
    Matrix *res = new Matrix(nrow, ncol);
