...
JNIEXPORT void JNICALL Java_blas_java_Matrix_setElementNative(JNIEnv *env, jobject jb, jint i, jint j, jboolean val, jlong ptr){
	LogicMatrix* mat = (LogicMatrix*)ptr;
	mat->setElement(i, j, val);
}


JNIEXPORT jboolean JNICALL Java_blas_java_Matrix_getElementNative(JNIEnv *env, jobject jb, jint i, jint j, jlong ptr){
	LogicMatrix* mat = (LogicMatrix*)ptr;
...
JNIEXPORT jlong JNICALL Java_blas_java_Matrix_ccLogicMatrixNative(JNIEnv *env, jobject jb, jint n, jint m){
	jint size = n * m;
