...
public:
    ...
    // in JAVA Native code, optimized version functions are called instead of original one
    ...
    // NOTE abandon optimizing those functions for not passing correctness test
    //
